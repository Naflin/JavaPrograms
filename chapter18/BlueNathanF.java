/*************************************************************\
|    Program: BlueNathanF.java                                |
|     Author: Nathan Blue                                     |
|   Due Date: 3/28/17                                         |
| Assignment: Chapter 18 Program                              |
|    Purpose: Use the example code from the book to create    |
...
public class BlueNathanF extends JFrame
{
		...
		new ActionListener()
			{
				...
				public void actionPerformed(ActionEvent event)
				{
					...
					BlueNathanF.this, "Choose a color", Color.BLUE);
	...
	{
		BlueNathanF fractals = new BlueNathanF();
		fractals.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	}
}