/**********************************************************\
|    Program: BlueNathanSC.java                            |
|     Author: Nathan Blue                                  |
|   Due Date: 9/13/16                                      |
| Assignment: Exercise 2.31                                |
|    Purpose: Display the numbers from 0-10 and then their |
|             squared and cubed versions                   |
\**********************************************************/


public class BlueNathanSC
{
